...
public class MainDriver { 
    ...
    { 
        ...
        System. out. println(" Calling sayHello on leaf1"); leaf1. sayHello();
        System. out. println("\nCalling sayHello on composite1"); composite1. sayHello();
        System. out. println("\nCalling sayHello on composite2"); composite2. sayHello();
